export const translations = {
  nl: {
    ...
    vibeGreatSuggestion: 'Vier dit. Vraag wat er goed werkt zodat je dit kunt behouden.',
    vibeGood: 'Team vibe is goed.',
    vibeGoodSuggestion: 'Stabiele basis. Check of er kleine dingen zijn die beter kunnen.',
    vibeAttention: 'Team vibe vraagt aandacht.',
    vibeAttentionSuggestion: 'Plan een gesprek met je team. Vraag wat hen bezighoudt.',
    vibeConcern: 'Team vibe is zorgelijk.',
    vibeConcernSuggestion: 'Neem dit serieus. Praat individueel met teamleden om te begrijpen wat er speelt.',
    ...
    ceremoniesExplanation: 'Ceremonies helpt je team groeien via Shu-Ha-Ri (守破離) — een Japans leerpad van basis naar meesterschap. Start bij Shu met kernpraktijken, unlock Ha door consistent te scoren, en bereik Ri voor geavanceerde thema\'s.',

    // Shu-Ha-Ri detailed explanation
    shuHaRiTitle: 'Het Shu-Ha-Ri Pad',
    shuHaRiIntro: 'Teams groeien door drie fases — elk met eigen thema\'s en diepgang.',
    shuLabel: 'Shu (守)',
    shuDescription: 'Leer de basis. Bouw de gewoonte. Vertrouw het proces.',
    haLabel: 'Ha (破)',
    haDescription: 'Pas bewust aan. Experimenteer veilig. Vind wat werkt voor jouw team.',
    riLabel: 'Ri (離)',
    riDescription: 'Overstijg het framework. Creëer je eigen aanpak. Leid door voorbeeld.',
    unlockHaTitle: 'Unlock Ha',
    unlockHaCriteria: '3 sessies in 30 dagen • Gem. score ≥ 3.2 • Deelname ≥ 60%',
    unlockRiTitle: 'Unlock Ri',
    unlockRiCriteria: '6 sessies totaal • 3 verschillende types • 4× follow-up • Gem. score ≥ 3.5 • Deelname ≥ 70%',
    sessionsTab: 'Sessies',
  ...
  en: {
    ...
    vibeGreatSuggestion: 'Celebrate this. Ask what\'s working well so you can maintain it.',
    vibeGood: 'Team vibe is good.',
    vibeGoodSuggestion: 'Solid foundation. Check if there are small things that could improve.',
    vibeAttention: 'Team vibe needs attention.',
    vibeAttentionSuggestion: 'Schedule a team conversation. Ask what\'s on their mind.',
    vibeConcern: 'Team vibe is concerning.',
    vibeConcernSuggestion: 'Take this seriously. Talk individually with team members to understand what\'s going on.',
    ...
    ceremoniesExplanation: 'Ceremonies helps your team grow via Shu-Ha-Ri (守破離) — a Japanese learning path from basics to mastery. Start at Shu with core practices, unlock Ha by scoring consistently, and reach Ri for advanced themes.',

    // Shu-Ha-Ri detailed explanation
    shuHaRiTitle: 'The Shu-Ha-Ri Path',
    shuHaRiIntro: 'Teams grow through three phases — each with unique themes and depth.',
    shuLabel: 'Shu (守)',
    shuDescription: 'Learn the basics. Build the habit. Trust the process.',
    haLabel: 'Ha (破)',
    haDescription: 'Adapt intentionally. Experiment safely. Find what works for your team.',
    riLabel: 'Ri (離)',
    riDescription: 'Transcend the framework. Create your own approach. Lead by example.',
    unlockHaTitle: 'Unlock Ha',
    unlockHaCriteria: '3 sessions in 30 days • Avg score ≥ 3.2 • Participation ≥ 60%',
    unlockRiTitle: 'Unlock Ri',
    unlockRiCriteria: '6 total sessions • 3 different types • 4× follow-up • Avg score ≥ 3.5 • Participation ≥ 70%',
