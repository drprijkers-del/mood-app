export const translations = {
  nl: {
    ...
    vibeFraming: 'Korte schommelingen zijn normaal. Kijk naar de richting, niet naar één dag.',
    vibeTrustNote: 'Betrouwbaarder naarmate meer teamleden meedoen.',
    ...
    ceremoniesFraming: 'Kies een thema, verzamel signalen, bespreek wat opvalt.',
    ...
    unlockHaTitle: 'Ha beschikbaar na',
    unlockHaCriteria: '3 sessies • 5 thema\'s • stabiele deelname',
    unlockRiTitle: 'Ri beschikbaar na',
    unlockRiCriteria: '6 sessies • 7 thema\'s • regelmatige opvolging',
    sessionsTab: 'Sessies',
  ...
  en: {
    ...
    vibeFraming: 'Short-term fluctuations are normal. Look at direction, not a single day.',
    vibeTrustNote: 'More reliable as more team members participate.',
    ...
    ceremoniesFraming: 'Pick a theme, collect signals, discuss what stands out.',
    ...
    unlockHaTitle: 'Ha available after',
    unlockHaCriteria: '3 sessions • 5 themes • stable participation',
    unlockRiTitle: 'Ri available after',
    unlockRiCriteria: '6 sessions • 7 themes • regular follow-through',
